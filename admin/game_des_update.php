...
<body>
<?php
$row = $dosql->GetOne("SELECT * FROM `pmw_gamedes` WHERE `id`=$id");
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
		  ...
		  <td width="64%" colspan="11"><input style="width:370px;" type="text" name="game_name" id="game_name" class="input" value="<?php echo $row['game_name']; ?>" /></td>
    </tr>
		<tr>
			<td height="82" align="right">游戏图片：</td>
			<td colspan="11" valign="middle">
      <div id="layer-photos-demo" class="layer-photos-demo">
     <img  width="90" height="90" style="cursor:pointer; padding:5px;border-radius:3px;" layer-src="<?php echo $row['game_pic']; ?>"  src="<?php echo $row['game_pic']; ?>" alt="<?php echo $row['game_name']; ?>" />
       </div>
   <input style="margin-top:5px;" type="text" name="game_pic" id="game_pic" class="input" value="<?php echo $row['game_pic']; ?>" />
      ...
      <tr>
		  ...
		  <td colspan="11"><textarea name="game_description" id="game_description" class="kindeditor"><?php echo $row['game_description']; ?></textarea>
				<script>
				var editor;
...
<input type="submit" class="submit" value="保存" />
		...
		<input type="hidden" name="action" id="action" value="update_gamedes" />
