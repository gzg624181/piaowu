...
?>
<div class="formHeader"> <span class="title" style="margin-left: 13px;">添加景区分类</span> <a href="javascript:location.reload();" class="reload"><i class="fa fa-refresh fa-spin fa-fw"></i></a> </div>
<form name="form" id="form" method="post" action="<?php echo $action;?>">
	<table id="table1"  width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable" >
         <tr>
			<td width="25%" height="40" align="right">分类标题：</td>
			<td width="75%">
			...
			<td>
              <input style="margin-top:5px;" type="text" name="icon" id="icon" class="input"  required="required"/>
				<span class="cnote">
	...
	<div class="formSubBtn">
		...
		<input type="hidden" name="action" id="action" value="add_ticket_class" />
  </div>
</form>
