...
<form name="form" id="form" method="post" action="infoclass_left_save.php" onsubmit="return cfm_infoclass();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			...
			<td><select name="parentid" id="parentid" onchange="GetCatpSize(this.value);">
					...
					<?php GetAllType('#@__infoclass_left','#@__infoclass_left','id'); ?>
				</select>
				<span class="maroon">*</span></td>
			<td>&nbsp;</td>
		</tr>
		...
		<tr>
			<td height="40" align="right">Font Awesome图标：</td>
		...
		<tr>
			...
			<td><input type="text" name="orderid" id="orderid" class="inputs" value="<?php echo GetOrderID('#@__infoclass_left'); ?>" /></td>
			<td>&nbsp;</td>
		</tr>
		<tr class="nb">
