...
<div class="loginTop" <?php echo GetLoginBg(); ?>>
	<div class="logo" style="display:none"><img src="templates/images/logo.png" width="197" height="43"></div>
</div>
<div class="loginWarp">
	<div class="loginArea">
		...
		<div class="loginForm">
			<form name="login" method="post" action="" onSubmit="return CheckForm()">
				<div class="txtLine">
					<label>用户名</label>
					<input type="text" name="username" id="username" placeholder="请输入用户名" class="uname input" maxlength="20" />
				</div>
				<div class="txtLine mar8">
					<label>密码</label>
					<input type="password" name="password" id="password" placeholder="请输入密码" class="pwd input" maxlength="16" />
				</div>
				<div class="quesArea">
			...
			<div class="loginThanks">技术支持：<span><?php echo $cfg_jishu;?></span></div>
		</div>
	</div>
</div>
<div class="loginCopyright">© <?php echo date('Y');?> <?php echo $cfg_weburl;?></div>
</body>
</html>
