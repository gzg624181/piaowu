...
<div class="homeHeader">
	...
	<div class="news">
		<div class="title"></div >
		<div style=" margin-top:-6px;">欢迎&nbsp;<font color="red"><b><?php echo $_SESSION['admin'];?></b></font>&nbsp;进入<?php echo $cfg_webname;?>后台管理中心！ </div>
	</div>
</div>
...
<div class="homeCopy"> 敬请您将在使用中发现的问题或者不适提交给我们，以便改进 <a href="http://new.internet-kf.com/" target="_blank" class="feedback">点击提交反馈</a></div>
<?php
