...
<body>
<div class="formHeader"> <span class="title">安卓客户端版本更新</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
		  <td height="40" align="right">上传路径：</td>
		  <td colspan="11" valign="middle">
            <input type="text" name="picurl" id="picurl" class="input" value="<?php echo $r['url'];?>" />
				<span class="cnote"><span class="grayBtn" onclick="GetUploadify('uploadify','软件APK上传','soft','soft',1,<?php echo $cfg_max_file_size; ?>,'picurl')"></span></span>（上传格式apk）
          ...
          <tr>
			...
			<td width="93%"><input style="width:390px;" type="text" name="lianjie" id="lianjie" value="<?php echo $r['lianjie'];?>" class="input"/></td>
	</tr>
      <tr>
     ...
     <img  width="305" height="305" style="cursor:pointer" layer-src="../<?php echo $r['picurl']; ?>"  src="../<?php echo $r['picurl']; ?>" />
            ...
            <input name="picurl1" type="text" class="input" id="picurl1" value="<?php echo $r['picurl'];?>" />
				<span class="cnote"><span class="grayBtn" onclick="GetUploadify('uploadify','缩略图上传','image','image',1,<?php echo $cfg_max_file_size; ?>,'picurl1')"></span></span></td>
    </tr>
	...
	<div class="formSubBtn" style="float:left; margin-left:115px;">
		...
		<input type="hidden" name="action" id="action" value="upapp_update" />
  </div>
